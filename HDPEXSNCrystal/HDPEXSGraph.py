...
ycapHDPENC = [34.17698948934166, 10.63803439120176, 3.3940446452106823, 150.0080364844656, 0.3308209195513364, 0.11277682731585711]
...
ax1.plot(x, ycapHDPE, 'o', markerfacecolor='none', ms=s, markeredgecolor='orange', label = "Capture (Geant4)")
#ax1.plot(x, yelHDPE, 'o', markerfacecolor='none', ms=s, markeredgecolor='r', label = "Elastic")
ax1.plot(x, ytotHDPE, 'o', markerfacecolor='none', ms=s, markeredgecolor='r', label = "Total (Geant4)")
...
ax1.plot(xe, ytotExperiment, **{'color': 'yellow', 'marker': '.'}, label = "Total Experiment")
