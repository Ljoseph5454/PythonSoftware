...
ax1.plot(x, ytotSapNC, 'o', markerfacecolor='none', ms=s, markeredgecolor='b', label = "Total XS (NCrystal, Bragg=0)")
ax1.plot(xcap, ycapSapNC, 'o', markerfacecolor='none', ms=s, markeredgecolor='mediumorchid', label = "Capture XS (NCrystal)")
ax1.plot(xinel, yinelSapNC, 'o', markerfacecolor='none', ms=s, markeredgecolor='black', label = "Inelastic XS (NCrystal)")
#ax1.plot(x, yelSap, 'o', markerfacecolor='none', ms=s, markeredgecolor='r', label = "Elastic")
ax1.plot(x, ytotSap, '^', markerfacecolor='none', ms=s, markeredgecolor='r', label = "Total XS (Geant4)")
ax1.plot(xcap, ycapSap, '^', markerfacecolor='none', ms=s, markeredgecolor='orange', label = "Capture XS (Geant4)")
ax1.plot(xinel, yinelSap, '^', markerfacecolor='none', ms=s, markeredgecolor='silver', label = "Inelastic XS (Geant4)")
ax1.plot(xe, ytotExperimentFA, **{'color': 'lawngreen', 'marker': '.'}, label = "Total (Free Atom) XS")
ax1.plot(xe, ycapExperiment, **{'color': 'lightsteelblue', 'marker': '.'}, label = "Capture XS (Experiment)")
ax1.plot(xe, ytotExperiment, **{'color': 'khaki', 'marker': '.'}, label = "Total XS (Experiment)")
